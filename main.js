...
function generateQRCode(data, outputPath) {
    return __awaiter(this, void 0, void 0, function () {
        var qrCode, qrCodeImage, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, qr.toDataURL(data)];
                case 1:
                    qrCode = _a.sent();
                    qrCodeImage = qrCode.split(",")[1];
                    fs.writeFileSync(outputPath, Buffer.from(qrCodeImage, "base64"));
                    console.log("QR code generated and saved to ".concat(outputPath));
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
...
try {
    var dataToEncode = String(process.argv[2]);
    var outputImagePath = "qrcode.png";
